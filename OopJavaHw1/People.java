...
public class People extends BasePeople{
    ...
    public People( String peopleSurname, String peopleName, String peoplePatronymic, long peopleAge, long peopleHeight, long peopleWeight, String peopleGender, Children child , Parents parent) {
