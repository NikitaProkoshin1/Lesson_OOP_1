...
public class Controller {
    public static void start ( Families families ) {
                ...
                while (exit) {
                    switch (Interface.mainPeople ( )) {
                        ...
                        case 2:
                            ...
                            continue;
                        case 3:
                            Interface.printAllChilds ( families.getFamily ( indexFamily ).getPeople ( Interface.indexPeopleInList ( families.getFamily ( indexFamily ) ) ).children.getChildren ( ) );
                            Interface.pressEnter ( );
                            continue;
                        case 4:
